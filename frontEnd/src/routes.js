...
import uploadPicture from './components/Upload/Uploadpicture/uploadpicture.vue'
...
const routes = [
  ...
  // 新建的功能模块：上传图片
  // component和name对应上面import的名字uploadPicture
  // module对应components下一级文件夹名Upload
  // menu对应Upload下的Uploadpicture
  // 完成这些后要在主菜单进行配置，注意和这些参数一一对应
  {
    path: '/home',
    component: Home,
    children: [
      { path: 'Uploadpicture/uploadpicture', component: uploadPicture, name: 'uploadPicture', meta: { hideLeft: false, module: 'Upload', menu: 'Uploadpicture' }}
    ]
  }
]
